...
class Kama_SEO_Tags
{
    ...
    static function meta_title($title = '')
    {
        ...
        elseif (is_singular() || (is_home() && !is_front_page()) || (is_page() && !is_front_page())) {
            ...
            if (!is_page()) {
                $parts['title'] = $parts['title'].' printing - best price';
            }
...
//                    echo 'prev 2';
                    $parts['prev'] = 'San Diego';//get_taxonomy( $term->taxonomy )->labels->name;
        ...
        if ($post->ID != 79) {
            $parts['after'] = '| bannerprintingsandiego.com';
        } else {
            $parts['after'] = '';
        }
    ...
    static function meta_description()
    {
        ...
        if (is_front_page()) {
            ...
            if (is_page()) {
                ...
                $desc = 'Print Banners in San Diego to promote your Business or Event ⚡️ Free San Diego Delivery ✅ Call Us 📱 +1 619-316-5780';
                $need_cut = false;
            }
        ...
        elseif (is_singular()) {
            ...
            if (!$desc) {
                ...
                $desc = 'Print ' . $post->post_title . ' in San Diego ⚡ Full color printing ⚡ 🔥 Free San Diego Delivery 🔥 Call us 📱 +1 619-316-5780';
            }

            if (get_post_type($post->ID) == 'page') {
                $desc = $post->post_title . '⚡ Full color printing ⚡ 🔥 Free San Diego Delivery 🔥 Call us 📱 +1 619-316-5780';
            }
        ...
        if (is_category() || is_tag() || is_tax()) {
            ...
            if (is_tax()) {
                $desc = 'Print '.$title.' in San Diego for Indoor and Outdoor Advertising 🔥 Free San Diego Delivery 🔥 Call us 📱 +1 619-316-5780';
            }
        }
