                            ...
                            <div class="prod__main_content">
                                <div class="prod__main_thumbs swiper">
                                    ...
                                    <div class="prod__main_thumbs_prev">
                                        <svg width="18" height="10" viewBox="0 0 18 10" fill="none"
                                            ...
                                            <path d="M1.50019 9.73123C1.16174 10.0794 0.600522 10.0847 0.255384 9.74304C-0.0786183 9.41239 -0.0859278 8.87856 0.238899 8.53907L8.13756 0.283686C8.49272 -0.0875205 9.08726 -0.0954989 9.45246 0.266041C9.80593 0.615962 9.81141 1.1816 9.46478 1.53817L1.50019 9.73123Z"
                                                  fill="#2F2F2F"/>
                                            <path d="M17.7456 8.53188C18.0848 8.86773 18.0848 9.41226 17.7456 9.74811C17.4063 10.084 16.8563 10.084 16.517 9.74811L8.53146 1.84259C8.19221 1.50674 8.19221 0.962209 8.53146 0.626355C8.87072 0.290501 9.42076 0.290501 9.76001 0.626355L17.7456 8.53188Z"
                                                  fill="#2F2F2F"/>
                                        </svg>
                                    ...
                                    <div class="prod__main_thumbs_next">
                                        <svg width="18" height="10" viewBox="0 0 18 10" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path d="M16.4998 0.268772C16.8383 -0.0793941 17.3995 -0.0847205 17.7446 0.256958C18.0786 0.587613 18.0859 1.12144 17.7611 1.46093L9.86244 9.71631C9.50728 10.0875 8.91274 10.0955 8.54754 9.73396C8.19407 9.38404 8.18859 8.8184 8.53522 8.46183L16.4998 0.268772Z"
                                                  fill="#2F2F2F"/>
                                            <path d="M0.254442 1.46812C-0.0848122 1.13227 -0.0848122 0.587743 0.254442 0.25189C0.593695 -0.0839642 1.14373 -0.0839641 1.48299 0.25189L9.46854 8.15741C9.80779 8.49326 9.80779 9.03779 9.46854 9.37364C9.12928 9.7095 8.57924 9.7095 8.23999 9.37364L0.254442 1.46812Z"
                                                  fill="#2F2F2F"/>
                                        </svg>
                                ...
                                <div class="prod__main_descr">
                                    ...
                                    <div class="prod__main_descr_action">
                                        <button class="prod__main_descr_action_btn product-action-consultation">
                            ...
                            <div class="container">
                                <div class="feed__in">
                                    <form class="feed__body">
                                        ...
                                        <input type="tel" id="telInput" class="feed__body_input"
                                               placeholder="+7 (495) 555-55-55">
                                        <button class="feed__body_btn">
                                            Получить консультацию
                                        </button>
                                        <div class="feed__body_link">
                                            при нажатии на кнопку вы соглашаетесь с <a href="#">политикой
                                    ...
                                    <div class="feed__img">
                                        <picture>
                                            ...
                                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/feed/feed-img.png"
                                                 alt="">
                                        </picture>
                                    </div>
                                </div>
                        ...
                        <div class="prod__descr">
                            ...
                            <?php if (!empty($product->get_description())): ?>
                                <div class="prod__descr_item active" id="descripton">
                                    ...
                                    <div class="prod__descr_item_body">
                                        ...
                                        <div class="video">
                                            <iframe width="1097" height="617" src="<?= $video_url ?>"
                            ...
                            <?php if (!empty($example)): ?>
                                <div class="prod__descr_item active" id="examples">
                                    <div class="prod__descr_item_head">
                                        <div class="prod__descr_item_head_title">Примеры эхограмм
                                            <span><?= the_title() ?></span></div>
                                    </div>
                                    <div class="prod__descr_item_body">
                                        <div class="examples">
                                                ...
                                                <div class="examples__slider_wr swiper-wrapper">
                                                    <?php foreach ($example as $item): ?>
                                                        <a data-fancybox="gallery" href="<?= $item['image'] ?>"
                                                           class="examples__slider_sl swiper-slide">
                                                            <picture>
                                ...
                                <div class="prod__rates">
                                    ...
                                    <div class="prod__rates_list">
                                        <?php foreach ($ratings as $item): ?>
                                            <a href="<?= $item['url'] ?>"
                                               class="prod__rates_list_item"><?= $item['title'] ?></a>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                                            ...
                                            if (empty($comment->comment_parent) && $comment->comment_approved == 1) :
                                                ...
                                                <div class="prod__comment_list_item">
                                                    ...
                                                    <div class="action">
                                                        ...
                                                        <button class="action__btn comment-answer-btn"
                                                                data-comment="<?= $comment->comment_ID ?>">Ответить
                                                        </button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="sensor__main_body_content_part">
                                        ...
                                        <div class="list">
                                            <?php foreach ($first_part as $id):
                                                $similar = wc_get_product($id);
                                                ?>
                                                <a href="<?= $similar->get_permalink() ?>"
                                                   class="list__item"><?= $similar->get_title() ?></a>
                                            <?php endforeach; ?>
                                        </div>
