                ...
                <div class="header__top">
                    <div class="header__left">
                        <a href="<?= get_home_url() ?>" class="header__logo">
                            <picture>
                                <source srcset="<?= $header['logo']['url'] ?>" type="image/webp">
                                <img src="<?= $header['logo']['url'] ?>" alt="<?= get_bloginfo('name'); ?>">
                            </picture>
                            <?php if ($header['logo_text']): ?>
                                <p class="header__logo-text"><?= $header['logo_text'] ?></p>
                            <?php endif; ?>
                        </a>
                    ...
                    <div class="header__right">
                        ...
                        <div class="header__link">
                            ...
                            <a href="mailto:siteadressmail@mail.ru"
                               class="header__link_value"><?= $header['email'] ?></a>
                        </div>
                    </div>
                    ...
                    <button class="header__sr" id="searchFieldToggler">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.96875 17.1875C13.9556 17.1875 17.1875 13.9556 17.1875 9.96875C17.1875 5.98194 13.9556 2.75 9.96875 2.75C5.98194 2.75 2.75 5.98194 2.75 9.96875C2.75 13.9556 5.98194 17.1875 9.96875 17.1875Z"
                                  stroke="#5C82E4" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M15.0732 15.0732L19.2499 19.2499" stroke="#5C82E4" stroke-linecap="round"
