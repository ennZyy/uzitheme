...
"undefined"!=typeof jQuery&&function(b){function q(){return"undefined"!=typeof wp&&"undefined"!=typeof wp.hooks&&"undefined"!=typeof wp.hooks.applyFilters?wp.hooks.applyFilters.apply(null,arguments):"undefined"!=typeof arguments[1]?arguments[1]:!1}function r(){var a=b(window).width();return 640>=a?"phone":1024>=a?"tablet":"desktop"}function g(){try{return document.createEvent("TouchEvent"),!0}catch(a){return!1}}function k(a){return encodeURIComponent(a).replace(/%20/g,"+")}function l(a,c,e,d){var f=
b("<form />",{action:a,method:c,style:"display: none;"});"undefined"!==typeof e&&null!==e&&b.each(e,function(n,h){b("<input />",{type:"hidden",name:n,value:h}).appendTo(f)});"undefined"!=typeof d&&"new"==d&&f.attr("target","_blank");f.appendTo("body").trigger("submit")}function t(a){b('<a href="'+a+'" target="_blank">').get(0).click()}function m(){return"undefined"!=typeof window.navigator&&"undefined"!=typeof window.navigator.userAgent?null!=window.navigator.userAgent.match(/(iPod|iPhone|iPad)/):
!1}var u;"function"!==typeof Object.create&&(Object.create=function(a){function c(){}c.prototype=a;return new c});b.plugin=function(a,c){b.fn[a]=function(e){return this.each(function(){b.data(this,a)||b.data(this,a,Object.create(c).init(e,this))})}};b.plugin("ajaxsearchlite",{init:function(a,c){this.elem=c;this.$elem=b(c);this.searching=!1;this.o=b.extend({blocking:!1},a);this.n={};this.n.search=b(this.elem);this.n.container=this.n.search.closest(".asl_w_container");this.o.id=this.n.search.data("id");
this.o.iid=this.n.search.data("instance");this.o.rid=this.o.id;this.n.probox=b(".probox",this.n.search);this.n.proinput=b(".proinput",this.n.search);this.n.text=b(".proinput input.orig",this.n.search);this.n.textAutocomplete=b(".proinput input.autocomplete",this.n.search);this.n.loading=b(".proinput .loading",this.n.search);this.n.proloading=b(".proloading",this.n.search);this.n.proclose=b(".proclose",this.n.search);this.n.promagnifier=b(".promagnifier",this.n.search);this.n.prosettings=b(".prosettings",
this.n.search);this.n.searchsettings=b(".asl_s",this.n.container);this.n.resultsDiv=b(".asl_r",this.n.container);this.fixClonedSelf();this.n.searchsettings=this.n.searchsettings.clone();b("body").append(this.n.searchsettings);this.n.searchsettings.get(0).id=this.n.searchsettings.get(0).id.replace("__original__","");this.n.resultsDiv=this.n.resultsDiv.clone();"hover"==this.o.resultsposition?b("body").append(this.n.resultsDiv):0<this.n.resultsAppend.length&&this.n.resultsAppend.append(this.n.resultsDiv);
this.n.resultsDiv.get(0).id=this.n.resultsDiv.get(0).id.replace("__original__","");this.n.hiddenContainer=b("#asl_hidden_data");this.n.aslItemOverlay=b(".asl_item_overlay",this.n.hiddenContainer);this.resizeTimeout=null;this.n.showmore=b(".showmore",this.n.resultsDiv);this.n.items=b(".item",this.n.resultsDiv);this.n.results=b(".results",this.n.resultsDiv);this.n.resdrg=b(".resdrg",this.n.resultsDiv);this.postAuto=this.post=null;this.n.textAutocomplete.val("");this.scroll={};this.savedContainerTop=
this.savedScrollTop=0;this.is_scroll="undefined"!=typeof asp_SimpleBar;"undefined"!=typeof ASL.scrollbar&&0==ASL.scrollbar&&(this.is_scroll=!1);this.settScroll=null;this.n.resultsAppend=b("#wpdreams_asl_results_"+this.o.id);this.o.redirectOnClick="ajax_search"!=this.o.trigger.click&&"nothing"!=this.o.trigger.click;this.o.redirectOnEnter="ajax_search"!=this.o.trigger.return&&"nothing"!=this.o.trigger.return;this.lastSuccesfulSearch="";this.lastSearchData={};this.triggerPrevState=!1;"undefined"==typeof ASL.resHTML&&
(ASL.resHTML=this.n.resultsDiv.html());"undefined"==typeof ASL.setHTML&&(ASL.setHTML=this.n.searchsettings.html());b("fieldset",this.n.searchsettings).each(function(){b(".asl_option:not(.hiddend)",this).last().addClass("asl-o-last")});this.monitorTouchMove();0<window.navigator.userAgent.indexOf("MSIE ")&&this.n.search.addClass("asl_msie");this.initSettingsAnimations();this.initResultsAnimations();this.initEvents();this.initAutop();this.initEtc();return this},monitorTouchMove:function(){var a=this,
c=b("body");a.dragging=!1;c.on("touchmove",function(){a.dragging=!0});c.on("touchstart",function(){a.dragging=!1})},gaPageview:function(a){var c=this.gaGetTrackingID();if("undefined"==typeof ASL.analytics||"pageview"!=ASL.analytics.method)return!1;if(""!=ASL.analytics.string){var e="function"==typeof __gaTracker?__gaTracker:"function"==typeof ga?ga:!1,d="function"==typeof gtag?gtag:!1;window.location.origin||(window.location.origin=window.location.protocol+"//"+window.location.hostname+(window.location.port?
":"+window.location.port:""));var f=this.o.homeurl.replace(window.location.origin,"");!1!==d?!1!==c&&d("config",c,{page_path:f+ASL.analytics.string.replace("{asl_term}",a)}):!1!==e&&(!1!==c&&e("create",c,"auto"),e("send","pageview",{page:f+ASL.analytics.string.replace("{asl_term}",a),title:"Ajax Search"}))}},gaEvent:function(a,c){var e=this.gaGetTrackingID();if("undefined"==typeof ASL.analytics||"event"!=ASL.analytics.method)return!1;var d="function"==typeof gtag?gtag:!1,f="function"==typeof __gaTracker?
__gaTracker:"function"==typeof ga?ga:!1;if(!1===d&&!1===f)return!1;if("undefined"!=typeof ASL.analytics.event[a]&&1==ASL.analytics.event[a].active){var n={search_id:this.o.id,search_name:this.o.name,phrase:this.n.text.val(),option_name:"",option_value:"",result_title:"",result_url:"",results_count:""},h={event_category:ASL.analytics.event[a].category,event_label:ASL.analytics.event[a].label,value:ASL.analytics.event[a].value};c=b.extend(n,c);b.each(c,function(v,p){p=String(p).replace(/[\s\n\r]+/g,
" ").trim();b.each(h,function(w,x){h[w]=x.replace(new RegExp("{"+v+"}","gmi"),p)})});!1===d?(!1!==e&&f("create",e,"auto"),f("send","event",h.event_category,ASL.analytics.event[a].action,h.event_label,h.value)):(!1!==e&&(h.send_to=e),d("event",ASL.analytics.event[a].action,h))}},gaGetTrackingID:function(){if("undefined"==typeof ASL.analytics)return!1;if("undefined"!=typeof ASL.analytics.tracking_id&&""!=ASL.analytics.tracking_id)return ASL.analytics.tracking_id;if(!1!==("function"==typeof gtag?gtag:
!1)&&"undefined"!=typeof ga&&"undefined"!=typeof ga.getAll){var a=!1;ga.getAll().forEach(function(c){a=c.get("trackingId")});return a}return!1},createVerticalScroll:function(){this.is_scroll&&"undefined"===typeof this.scroll.recalculate&&(this.scroll=new asp_SimpleBar(this.n.results.get(0),{direction:b("body").hasClass("rtl")?"rtl":"ltr",autoHide:!0}))},initEvents:function(){var a=this;if(g()&&m())a.n.text.on("touchstart",function(){a.savedScrollTop=b(window).scrollTop();a.savedContainerTop=a.n.search.offset().top});
a.n.text.on("click",function(d){b(this).trigger("focus");a.gaEvent("focus")});a.n.text.on("focus input",function(d){a.searching||(""!=b(this).val()?a.n.proclose.css("display","block"):a.n.proclose.css({display:"none"}))});b(a.n.text.parent()).on("submit",function(d){d.preventDefault();g()?a.o.redirectOnEnter?(d=jQuery.Event("keyup"),d.keyCode=d.which=13,a.n.text.trigger(d)):"ajax_search"==a.o.trigger.return&&(a.search(),document.activeElement.blur()):"ajax_search"==a.o.trigger.return&&a.search()});
a.n.resultsDiv.css({opacity:0});b(document).on("click touchend",function(){a.hideSettings();0!=a.opened&&1==a.o.closeOnDocClick&&a.hideResults()});a.n.proclose.on("click touchend",function(){a.n.text.val("");a.n.textAutocomplete.val("");a.hideResults();a.n.text.trigger("focus")});b(a.elem).on("click touchend",function(d){d.stopImmediatePropagation()});a.n.resultsDiv.on("click touchend",function(d){d.stopImmediatePropagation()});a.n.searchsettings.on("click touchend",function(d){d.stopImmediatePropagation()});
a.n.prosettings.on("click",function(){0==a.n.prosettings.data("opened")?a.showSettings():a.hideSettings()});if(0<a.n.search.parents().filter(function(){return"fixed"==b(this).css("position")}).length||"fixed"==a.n.search.css("position"))"absolute"==a.n.resultsDiv.css("position")&&a.n.resultsDiv.css("position","fixed"),a.n.resultsDiv.css("z-index",99999999999),a.o.blocking||a.n.searchsettings.css("position","fixed");if(g())b(window).on("orientationchange",function(){a.orientationChange();setTimeout(function(){a.orientationChange()},
800)});else{var c;b(window).on("resize",function(){clearTimeout(c);c=setTimeout(function(){a.resize()},100)})}var e;b(window).on("scroll",function(){clearTimeout(e);e=setTimeout(function(){a.scrolling(!1)},400)});m()&&g()&&16>parseInt(a.n.text.css("font-size"))&&(a.n.text.data("fontSize",a.n.text.css("font-size")).css("font-size","16px"),a.n.textAutocomplete.css("font-size","16px"),b("<style>#ajaxsearchlite"+a.o.rid+" input.orig::-webkit-input-placeholder{font-size: 16px !important;}</style>").appendTo("head"));
a.initNavigationEvent();a.initMagnifierEvent();a.initAutocompleteEvent();a.initFacetEvents()},initAutop:function(){if(null!=u&&this.triggerPrevState)return this.search(),u=null,!1},initEtc:function(){var a=this,c=null;b("div.asl_option",a.n.searchsettings).on("mouseup touchend",function(e){e.preventDefault();e.stopImmediatePropagation();if(a.dragging)return!1;b('input[type="checkbox"]',this).prop("checked",!b('input[type="checkbox"]',this).prop("checked"));clearTimeout(c);var d=this;c=setTimeout(function(){b('input[type="checkbox"]',
d).trigger("asl_chbx_change")},50)});b("div.asl_option label",a.n.searchsettings).on("click",function(e){e.preventDefault()});a.n.resultsDiv.on("click",".results .item",function(){a.gaEvent("result_click",{result_title:b(this).find("a.asl_res_url").text(),result_url:b(this).find("a.asl_res_url").attr("href")});1==a.o.singleHighlight&&(localStorage.removeItem("asl_phrase_highlight"),""!=a.n.text.val().replace(/"|'/g,"")&&localStorage.setItem("asl_phrase_highlight",JSON.stringify({phrase:a.n.text.val().replace(/"|'/g,
""),id:a.o.id})))});if(g()&&""!=a.o.mobile.menu_selector)b(a.o.mobile.menu_selector).on("touchend",function(){var e=this;setTimeout(function(){var d=b(e).find("input.orig");d=0==d.length?b(e).next().find("input.orig"):d;d=0==d.length?b(e).parent().find("input.orig"):d;d=0==d.length?a.n.text:d;a.n.search.is(":visible")&&d.get(0).focus()},300)})},initNavigationEvent:function(){var a=this;b(a.n.resultsDiv).on("mouseenter",".item",function(){b(".item",a.n.resultsDiv).removeClass("hovered");b(this).addClass("hovered")});
b(a.n.resultsDiv).on("mouseleave",".item",function(){b(".item",a.n.resultsDiv).removeClass("hovered")});b(document).on("keydown",function(c){if(window.event)var e=window.event.keyCode;else c&&(e=c.which);if(0<b(".item",a.n.resultsDiv).length&&"none"!=a.n.resultsDiv.css("display")){if(40==e||38==e){40==e&&(a.n.text.blur(),0==b(".item.hovered",a.n.resultsDiv).length?b(".item",a.n.resultsDiv).first().addClass("hovered"):b(".item.hovered",a.n.resultsDiv).removeClass("hovered").next(".item").addClass("hovered"));
38==e&&(a.n.text.blur(),0==b(".item.hovered",a.n.resultsDiv).length?b(".item",a.n.resultsDiv).last().addClass("hovered"):b(".item.hovered",a.n.resultsDiv).removeClass("hovered").prev(".item").addClass("hovered"));c.stopPropagation();c.preventDefault();var d=a.is_scroll?b(a.scroll.getScrollElement()):a.n.results,f=a.n.resultsDiv.find(".resdrg .item.hovered");0==f.length&&(f=a.n.resultsDiv.children().first());d.animate({scrollTop:f.offset().top-d.offset().top+d.scrollTop()},{duration:120})}13==e&&0<
b(".item.hovered",a.n.resultsDiv).length&&(c.stopPropagation(),c.preventDefault(),b(".item.hovered a.asl_res_url",a.n.resultsDiv).get(0).click())}})},initMagnifierEvent:function(){var a=this,c,e,d=!1;a.n.text.on("keyup",function(f){window.event?(a.keycode=window.event.keyCode,a.ktype=window.event.type):f&&(a.keycode=f.which,a.ktype=f.type);if(13==a.keycode){clearTimeout(e);e=setTimeout(function(){d=!1},300);if(d)return!1;d=!0}f=b(this).hasClass("orig");if(a.n.text.val().length>=a.o.charcount&&f&&
"keyup"==a.ktype&&13==a.keycode){a.gaEvent("return");if(1==a.o.redirectOnEnter)"first_result"!=a.o.trigger.return?a.doRedirectToResults(a.ktype):a.search();else{if("nothing"==a.o.trigger.return)return!1;b("form",a.n.searchsettings).serialize()+a.n.text.val().trim()==a.lastSuccesfulSearch&&a.resultsOpened||a.search()}clearTimeout(c)}});a.n.promagnifier.add(a.n.text).on("click input",function(f){window.event?(a.keycode=window.event.keyCode,a.ktype=window.event.type):f&&(a.keycode=f.which,a.ktype=f.type);
f=b(this).hasClass("orig");if(a.n.text.val().length<a.o.charcount)a.n.proloading.css("display","none"),a.hideResults(),null!=a.post&&a.post.abort(),clearTimeout(c);else if(a.n.text.val().length>=a.o.charcount&&!f&&1==a.o.redirectOnClick&&"click"==a.ktype&&"first_result"!=a.o.trigger.click)a.doRedirectToResults(a.ktype),clearTimeout(c);else if(!(37<=a.keycode&&40>=a.keycode||112<=a.keycode&&123>=a.keycode))if(f&&"click"==a.ktype||32==a.keycode)b("form",a.n.searchsettings).serialize()+a.n.text.val().trim()==
a.lastSuccesfulSearch&&(a.n.proclose.css("display","block"),a.resultsOpened||a.showResults());else if(!b(this).hasClass("orig")||"click"!=a.ktype){f||"click"!=a.ktype||a.gaEvent("magnifier");if("click"==a.ktype&&"ajax_search"!=a.o.trigger.click&&"first_result"!=a.o.trigger.click)return!1;0==a.o.trigger.type&&"input"==a.ktype||f&&"input"==a.ktype&&"nothing"==a.o.trigger.return||!f&&"click"==a.ktype&&"nothing"==a.o.trigger.click||(null!=a.post&&a.post.abort(),clearTimeout(c),a.hideLoader(),c=setTimeout(function(){if(b("form",
a.n.searchsettings).serialize()+a.n.text.val().trim()!=a.lastSuccesfulSearch)a.search();else{a.n.proclose.css("display","block");if(a.isRedirectToFirstResult())return a.doRedirectToFirstResult(),!1;a.resultsOpened||a.showResults()}},250))}})},initFacetEvents:function(){var a=this,c=null;1==a.o.trigger.facet&&(b("input[type!=checkbox], select",a.n.searchsettings).on("change slidechange",function(){a.n.text.val().length<a.o.charcount||(null!=a.post&&a.post.abort(),clearTimeout(c),c=setTimeout(function(){a.search()},
50))}),b("input[type=checkbox]",a.n.searchsettings).on("asl_chbx_change",function(){a.n.text.val().length<a.o.charcount||(null!=a.post&&a.post.abort(),a.gaEvent("facet_change",{option_label:b(this).closest("fieldset").find("legend").text(),option_value:b(this).closest(".asl_option").find(".asl_option_label").text()+(b(this).prop("checked")?"(checked)":"(unchecked)")}),clearTimeout(c),c=setTimeout(function(){a.search()},50))}))},isRedirectToFirstResult:function(){return 0<b(".asl_res_url",this.n.resultsDiv).length&&
(1==this.o.redirectOnClick&&"click"==this.ktype&&"first_result"==this.o.trigger.click||1==this.o.redirectOnEnter&&("input"==this.ktype||"keyup"==this.ktype)&&13==this.keycode&&"first_result"==this.o.trigger.return)?!0:!1},doRedirectToFirstResult:function(){"same"==("click"==this.ktype?this.o.trigger.click_location:this.o.trigger.return_location)?location.href=b(b(".asl_res_url",this.n.resultsDiv).get(0)).attr("href"):t(b(b(".asl_res_url",this.n.resultsDiv).get(0)).attr("href"));this.hideLoader();
this.hideResults();return!1},doRedirectToResults:function(a){var c="click"==this.ktype?this.o.trigger.click:this.o.trigger.return;a="click"==a?this.o.trigger.click_location:this.o.trigger.return_location;c="results_page"==c?"?s="+k(this.n.text.val()):"woo_results_page"==c?"?post_type=product&s="+k(this.n.text.val()):this.o.trigger.redirect_url.replace("{phrase}",k(this.n.text.val()));1<this.o.homeurl.indexOf("?")&&0===c.indexOf("?")&&(c=c.replace("?","&"));this.o.overridewpdefault?"post"==this.o.override_method?
l(this.o.homeurl+c,"post",{asl_active:1,p_asl_data:b("form",this.n.searchsettings).serialize()},a):(c=this.o.homeurl+c+"&asl_active=1&p_asid="+this.o.id+"&p_asl_data=1&"+b("form",this.n.searchsettings).serialize(),"same"==a?location.href=c:t(c)):l(this.o.homeurl+c,"post",{np_asl_data:b("form",this.n.searchsettings).serialize()},a);this.n.proloading.css("display","none");this.hideLoader();this.hideResults();null!=this.post&&this.post.abort()},destroy:function(){this.n.searchsettings.remove();this.n.resultsDiv.remove();
...
"")},showResultsBox:function(){this.n.resultsDiv.css({display:"block",height:"auto"});this.n.items.addClass(this.animationOpacity);this.fixResultsPosition(!0);this.n.resultsDiv.css(this.resAnim.showCSS);this.n.resultsDiv.removeClass(this.resAnim.hideClass).addClass(this.resAnim.showClass)},showResults:function(){var a=this;a.createVerticalScroll();a.showVerticalResults();a.hideLoader();a.n.proclose.css({display:"block"});null!=a.n.showmore&&(0<a.n.items.length?a.n.showmore.css({display:"block"}):
a.n.showmore.css({display:"none"}));a.is_scroll&&"undefined"!==typeof a.scroll.recalculate&&setTimeout(function(){a.scroll.recalculate()},500);a.resultsOpened=!0},hideResults:function(){var a=this;if(!a.resultsOpened)return!1;a.n.resultsDiv.removeClass(a.resAnim.showClass).addClass(a.resAnim.hideClass);setTimeout(function(){a.n.resultsDiv.css(a.resAnim.hideCSS)},a.resAnim.duration);a.n.proclose.css({display:"none"});null!=a.n.showmore&&a.n.showmore.css({display:"none"});g()&&document.activeElement.blur();
a.resultsOpened=!1},scrollToResults:function(){$this=this;if(this.o.scrollToResults.enabled&&!this.$elem.parent().hasClass("asl_preview_data")){var a="hover"==$this.o.resultsposition?$this.n.probox.offset().top-20:$this.n.resultsDiv.offset().top-20;0<b("#wpadminbar").length&&(a-=b("#wpadminbar").height());a=0>a?0:a;b("body, html").animate({scrollTop:a},{duration:500})}},createGroup:function(a){return"<div class='group'>"+a+"</div>"},showVerticalResults:function(){this.showResultsBox();if(0<this.n.items.length){var a=
this.n.items.length<this.o.itemscount?this.n.items.length:this.o.itemscount;b(".group",this.n.resultsDiv);if(this.n.items.length<=this.o.itemscount)this.n.results.css({height:"auto"});else{this.n.results.css({height:30});this.resize();var c=0,e=0,d=0,f=0;this.n.items.each(function(){e+=b(this).outerHeight(!0);b(this).outerHeight(!0)>f&&(f=b(this).outerHeight(!0));c++});d=f*a;d>e&&(d=e);c=1>c?1:c;e=e/c*a;this.n.results.css({height:d})}this.resize();this.n.items.last().addClass("asl_last_item");1==
this.o.highlight&&(a=1==this.o.highlightwholewords?!0:!1,b("div.item",this.n.resultsDiv).highlight(this.n.text.val().split(" "),{element:"span",className:"highlighted",wordsOnly:a}))}this.resize();0==this.n.items.length&&this.n.results.css({height:"auto"});this.n.results.css({overflowY:"auto"});(this.is_scroll?b(this.scroll.getScrollElement()):this.n.results).scrollTop(0);this.fixResultsPosition(!0);this.searching=!1},initSettingsAnimations:function(){this.settAnim={showClass:"asl_an_fadeInDrop",
showCSS:{visibility:"visible",display:"block",opacity:1,"animation-duration":"300ms"},hideClass:"asl_an_fadeOutDrop",hideCSS:{visibility:"hidden",opacity:0,display:"none"},duration:300};this.n.searchsettings.css({"-webkit-animation-duration":this.settAnim.duration+"ms","animation-duration":this.settAnim.duration+"ms"})},initResultsAnimations:function(){this.resAnim={showClass:"asl_an_fadeInDrop",showCSS:{visibility:"visible",display:"block",opacity:1,"animation-duration":"300ms"},hideClass:"asl_an_fadeOutDrop",
hideCSS:{visibility:"hidden",opacity:0,display:"none"},duration:300};this.n.resultsDiv.css({"-webkit-animation-duration":"300ms","animation-duration":"300ms"})},showSettings:function(){var a=this;a.n.searchsettings.css(a.settAnim.showCSS);a.n.searchsettings.removeClass(a.settAnim.hideClass).addClass(a.settAnim.showClass);null==a.settScroll&&a.is_scroll&&(a.settScroll=[],b(".asl_sett_scroll",a.n.searchsettings).each(function(c,e){var d=this;setTimeout(function(){a.settScroll[c]=new asp_SimpleBar(b(d).get(0),
{direction:b("body").hasClass("rtl")?"rtl":"ltr",autoHide:!0})},20)}));a.n.prosettings.data("opened",1);a.fixSettingsPosition(!0)},hideSettings:function(){var a=this;a.n.searchsettings.removeClass(a.settAnim.showClass).addClass(a.settAnim.hideClass);setTimeout(function(){a.n.searchsettings.css(a.settAnim.hideCSS)},a.settAnim.duration);a.n.prosettings.data("opened",0)},fixClonedSelf:function(){let a=this.o.iid,c=this.o.rid;for(;!ASL.instances.set(this)&&!(++this.o.iid,50<this.o.iid););a!=this.o.iid&&
(this.o.rid=this.o.id+"_"+this.o.iid,this.n.search.get(0).id="ajaxsearchlite"+this.o.rid,this.n.search.removeClass("asl_m_"+c).addClass("asl_m_"+this.o.rid),this.n.searchsettings.get(0).id=this.n.searchsettings.get(0).id.replace("settings"+c,"settings"+this.o.rid),this.n.searchsettings.hasClass("asl_s_"+c)?this.n.searchsettings.removeClass("asl_s_"+c).addClass("asl_s_"+this.o.rid).data("instance",this.o.iid):this.n.searchsettings.removeClass("asl_sb_"+c).addClass("asl_sb_"+this.o.rid).data("instance",
this.o.iid),this.n.resultsDiv.get(0).id=this.n.resultsDiv.get(0).id.replace("prores"+c,"prores"+this.o.rid),this.n.resultsDiv.removeClass("asl_r_"+c).addClass("asl_r_"+this.o.rid).data("instance",this.o.iid),this.n.container.find(".asl_init_data").data("instance",this.o.iid),this.n.container.find(".asl_init_data").get(0).id=this.n.container.find(".asl_init_data").get(0).id.replace("asl_init_id_"+c,"asl_init_id_"+this.o.rid),this.n.prosettings.data("opened",0))},cleanUp:function(){0<b(".searchsettings",
this.n.search).length&&(b("body>#ajaxsearchlitesettings"+this.o.rid).remove(),b("body>#ajaxsearchliteres"+this.o.rid).remove())},orientationChange:function(){this.fixSettingsPosition();this.fixResultsPosition();this.fixTryThisPosition()},resize:function(){this.fixSettingsPosition();this.fixResultsPosition();this.fixTryThisPosition()},scrolling:function(a){this.fixSettingsPosition(a);this.fixResultsPosition(a)},fixTryThisPosition:function(){},fixResultsPosition:function(a){a="undefined"==typeof a?
!1:a;var c=this.n.resultsDiv.css("position");if("fixed"==c||"absolute"==c){var e=0;"static"!=b("body").css("position")&&(e=b("body").offset().top);if(1==a||"visible"==this.n.resultsDiv.css("visibility")){var d=a=0,f=this.n.search.offset();"fixed"==c&&(e=0,a=b(document).scrollTop(),d=b(document).scrollLeft(),g()&&m()&&this.n.text.is(":focus")&&(a=this.savedScrollTop,f.top=this.savedContainerTop));"undefined"!=typeof f&&(c="phone"==r()?this.o.results.width_phone:"tablet"==r()?this.o.results.width_tablet:
this.o.results.width,"auto"==c&&(c=240>this.n.search.outerWidth()?240:this.n.search.outerWidth()),this.n.resultsDiv.css({width:isNaN(c)?c:c+"px",top:f.top+this.n.search.outerHeight(!0)-e-a,left:f.left-d}))}}},fixSettingsPosition:function(a){a="undefined"==typeof a?!1:a;var c=0;"static"!=b("body").css("position")&&(c=b("body").offset().top);if((1==a||0!=this.n.prosettings.data("opened"))&&1!=this.o.blocking){this.fixSettingsWidth();a="none"!=this.n.prosettings.css("display")?this.n.prosettings:this.n.promagnifier;
var e=a.offset(),d=0,f=0;"fixed"==this.n.searchsettings.css("position")&&(d=b(window).scrollTop(),f=b(window).scrollLeft(),g()&&m()&&this.n.text.is(":focus")&&(e.top=this.savedContainerTop,d=this.savedScrollTop));"left"==this.o.settingsimagepos?this.n.searchsettings.css({display:"block",top:e.top+a.height()-2-c-d,left:e.left-f}):this.n.searchsettings.css({display:"block",top:e.top+a.height()-2-c-d,left:e.left+a.width()-this.n.searchsettings.width()-f})}},fixSettingsWidth:function(){}})}(jQuery);
